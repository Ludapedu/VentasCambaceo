...
public class BaseDatos extends SQLiteOpenHelper{
    ...
    String TablaPagos = "CREATE TABLE Pagos (IDREG INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, Cliente text, Fecha text, Monto int)";
    String TablaVentas = "CREATE TABLE Ventas (IDREG INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,Cliente text, Catalogo text, Pagina int, Marca text, ID int, Numero int, Costo int, Precio int, Entregado text)";
